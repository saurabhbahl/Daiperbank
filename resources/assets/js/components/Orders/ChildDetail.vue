			...
			<div class="pa oy-auto">
				...
				<div v-else-if="isEditing">
					...
					<div class="flex justify-end pt3">
						<div class="w-60 mr fg-no" v-if="selectedProduct.category && selectedProduct.category.id == 2">
...
export default {
	...
	computed: {
		showErrors() {
			return this.selectedProduct.product_id != null || this.selectedProduct.quantity != null || this.EditedChild.weight != null;
		},
