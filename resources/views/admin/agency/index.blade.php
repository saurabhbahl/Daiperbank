                ...
                <ul class="nav nav-tabs ph3 pt3">
                    <li class="dropdown bg-white active clickable:important">
                        <a href="#" class="dropdown-toggle clickable:important" data-toggle="dropdown">
                            <?= e($selected_order_status ? ($selected_order_status == 'all' ? 'All Status' : Agency::agencyStatusText($selected_order_status)) : 'Search results') ?>
                        ...
                        <div class="bb b--black-20 flex justify-start">
                            ...
                            <div class="pa w-25">
                                ...
                                <p class="agencyemail__input">
                                    <label for="agency_email" id="agency_email">
                                        <input type="checkbox" value="<?= e($Contact->email) ?>"><a id="mail"
                                            href="mailto:<?= e($Contact->email) ?>"><?= e($Contact->email) ?></a></label>
                                </p>
                                <? endif; ?>
                            ...
                            <div class="pa flex-auto tc w-15">
                                ...
                                <div class="flex flex-auto mt3 justify-center">
                                    ...
                                    <?= Form::open(['method' => 'get', 'route' => ['admin.agency.profile', $Agency->id]]) ?>
                                ...
                                <a href="#" onclick="this.parentElement.submit();" class="btn btn-block btn-default">
                ...
                <div class="col-xs-4 pb flex flex-column justify-start oy-auto">
                    ...
                    <div class="mv4 bg-white br3 py4 px4">
                        <form method="get">
                            <div class="mb">
                                <p class="b">Search</p>
                                <input name="filter[search]" type="search" class="form-control"
...
@section('js')
    <script>
        $(document).ready(function() {
            $(".agencyemail__input input[type='checkbox']").change(function() {
                var emailArray = [];
                $(".agencyemail__input input[type='checkbox']").each(function() {
                    if ($(this).is(':checked')) {
                        emailArray.push($(this).val());
                    }
                });
                var selectedEmails = emailArray.toString();
                window.location = 'mailto:' + selectedEmails;
            });
        });
    </script>
@endsection
