...
@section('content')
    ...
    <div class="breadcrumbs">
        <p class="crumb">Update Agreement</p>
    </div>
    ...
    <div class="flex-auto flex justify-start content-stretch o-hidden">
        <div class="col-xs-8 bg-white br b--black-20 flex-auto oy-auto pa3">
            ...
            @endif
            <form action="{{ route('admin.agreement.update', $agreement->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                            ...
                            <div class="col-xs-12 pa0 pr4">
                                <div class="pb">
                                    ...
                                    <input type="file" name="file" id="file" class="form-control"
                                        required="required" value="{{ $agreement->file }}"
